...
namespace NinjaTrader.Indicator {
    ...
    public class KriegCandleSticksPatterns : Indicator {
...
#region Variables
    ...
    private KriegChartPattern 	pattern 							= KriegChartPattern.MorningStar;
    private int 			patternsFound;
    private Font 			textFont 							= new Font("Arial", 12, FontStyle.Bold);
    private int				trendStrength						= 4;
    private Color 			txtColor;
    
//     private ArrayList CandleStickValues = new ArrayList();
#endregion
...
#region CandleStick Patterns Functions
    ...
    /*
    public int PatternIndex(KriegChartPattern pattern) {
        switch (pattern) {
        case KriegChartPattern.BearishBeltHold
            return 0;
        case KriegChartPattern.BearishEngulfing
            return 0;
        case KriegChartPattern.BearishHarami
            return 0;
        case KriegChartPattern.BearishHaramiCross
            return 0;
        case KriegChartPattern.BullishBeltHold
            return 0;
        case KriegChartPattern.BullishEngulfing
            return 0;
        case KriegChartPattern.BullishHarami
            return 0;
        case KriegChartPattern.BullishHaramiCross
            return 0;
        case KriegChartPattern.DarkCloudCover
            return 0;
        case KriegChartPattern.Doji
            return 0;
        case KriegChartPattern.DownsideTasukiGap
            return 0;
        case KriegChartPattern.EveningStar
            return 0;
        case KriegChartPattern.FallingThreeMethods
        case KriegChartPattern.Hammer
        case KriegChartPattern.HangingMan
        case KriegChartPattern.InvertedHammer
        case KriegChartPattern.MorningStar
        case KriegChartPattern.PiercingLine
        case KriegChartPattern.RisingThreeMethods
        case KriegChartPattern.ShootingStar
        case KriegChartPattern.StickSandwich
        case KriegChartPattern.ThreeBlackCrows
        case KriegChartPattern.ThreeWhiteSoldiers
        case KriegChartPattern.UpsideGapTwoCrows
        case KriegChartPattern.UpsideTasukiGap
        }
    }
    */
