...
// * поддержку.
// ===================================================================
//* Линия 7/8  (Слабая, место для остановки и разворота). Weak, Stall 
//* and Reverse
...
// ===================================================================
//* Линия 1/8  (Слабая, место для остановки и разворота). Weak, Stall
//* and Reverse
//* Эта линия слаба. Если цена зашла слишком далеко и слишком быстро 
//* и если она остановилась около этой линии, 
...
//* продавать в этой «премиальной зоне», что и делают некоторые люди,
//* но если цена сохраняет тенденцию оставаться 
