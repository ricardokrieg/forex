...
extern double    TakeProfit=20; // TP of 60pips
extern double    StopLoss=20; // SL of 30pips
...
double CalcLotsBasedLoss() {
     ...
     if (OrderProfit() < 0) { RiskPercent = Risk + RiskPercent  ; if (RiskPercent > MaxRisk) {RiskPercent=MaxRisk;} }
